                ...
                <header className="header">
                  <h1>DILEEPS SHOPPING SITE</h1>
                    ...
                    <div className='navlink'> 
                            <Link to="/"><button class="btn">Home</button>
                            </Link>
                        <Link to="/join"><button class="btn">Join our Community</button>
                        </Link>
                    </div>  
                </header>
                <Routes>
...
const Join = () => {
    ...
    return (
        <div className="join-page">
            ...
            <button onClick={handleNavigate} className='btn'>Back to Store</button>
        </div>
    );
};
